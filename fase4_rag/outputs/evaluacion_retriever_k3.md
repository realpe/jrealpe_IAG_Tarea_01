...
**Ejecutado**: 2026-09-18 11:39 · `nomic-embed-text` · k = 3 · 8 preguntas
...
**recall@3 = 7/8** · casos críticos 2/3
...
| El producto me causo una reaccion alergica, que hago? | OK | — |
| Cuanto se demora el reembolso? | OK | — |
| Me pueden dar un descuento por la demora? | **FALLA** 🔴 | `Prohibido`; `compensaciones` |

## Estrategia `fija`

**recall@3 = 5/8** · casos críticos 1/3
...
| Me pueden dar un descuento por la demora? | OK | — |

## Resumen

| Estrategia | recall@3 | Casos críticos |
| :--- | :---: | :---: |
| `seccion` | 7/8 | 2/3 |
| `fija` | 5/8 | 1/3 |
